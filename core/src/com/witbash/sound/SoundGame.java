...
public class SoundGame {
    public Sound soundShoot = Gdx.audio.newSound(Gdx.files.internal("Sound_shoot_laser.mp3"));
    public Sound soundExplosion = Gdx.audio.newSound(Gdx.files.internal("Sound_explosion.mp3"));
